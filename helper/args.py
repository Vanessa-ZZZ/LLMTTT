...
def get_command_line_args():
     ...
     parser.add_argument('--lr_ttt', type=float, default=0.001)
     parser.add_argument('--lr_ttt_1', type=float, default=0.001)
     parser.add_argument('--lr_ttt_2', type=float, default=0.001)
     parser.add_argument('--changed', type=int, default=1)
     parser.add_argument('--weight_decay', type=float, default=5e-4)
     parser.add_argument('--probability', type=float, default=0.5)
     parser.add_argument('--probability_stage', type=float, default=0.2)
     ...
     parser.add_argument("--debug_active", type=int, default=0)
